...
public class DotButton extends JButton {
	...
	private int column;
	private int iconNumber = COVERED;
	private int row;
    ...
    // ADD YOU CODE HERE
        ...
        setIconNumber(this.iconNumber);
		setDisabledIcon(new ImageIcon("icons/Minesweeper_flag.png"));
    }
	...
	/**
	 * returns the icon number of the specified tile
	 *
	 * @return iconNumber of tile
	 *
	 */
